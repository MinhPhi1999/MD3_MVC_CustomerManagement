...
public class CustomerServlet extends HttpServlet {
    ...
    //    thực hiện thao tác cập nhật thông tin khách hàng vào trong danh sách khách hàng giả lập
    ...
    //    trả về một form được định nghĩa trong view customer/create.jsp:
    ...
    //    nhận về các tham số được gửi lên từ form, khởi tạo đối tượng Customer
